...
import com.gvtech.repository.movie.WatchProviderRepository;
...
public class WatchProviderFilterListProvider extends AbstractCacheableContentProvider<List<Filter>> {
    ...
    public ContentBuild<List<Filter>> build(ContentId contentId) {
        ...
        final List<Filter> filters = Filter.mapMovieWatchProviders(watchProviderEntities);
    ...
    public ContentType type() {
        return new ContentType("MOVIE_WATCH_PROVIDER_FILTER_LIST");
    }
