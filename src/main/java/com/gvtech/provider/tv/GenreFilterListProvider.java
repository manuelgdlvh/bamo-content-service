...
import com.gvtech.entity.tv.GenreDetailsEntity;
import com.gvtech.model.Filter;
import com.gvtech.repository.tv.GenreDetailsRepository;
...
public class GenreFilterListProvider extends AbstractCacheableContentProvider<List<Filter>> {
    ...
    public ContentBuild<List<Filter>> build(ContentId contentId) {
        ...
        final List<Filter> filters = Filter.mapTvGenres(genreDetailsEntities);
    ...
    public ContentType type() {
        return new ContentType("TV_GENRE_FILTER_LIST");
    }
