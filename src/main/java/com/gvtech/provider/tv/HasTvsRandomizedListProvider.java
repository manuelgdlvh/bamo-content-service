...
@ApplicationScoped
@Startup
public class HasTvsRandomizedListProvider implements ContentProvider<Boolean> {
    ...
    public Boolean get(ContentId contentId) {
        ...
        final Set<Long> ids = tvIdsProvider.get(movieIdsContentId);
    ...
    public ContentType type() {
        return new ContentType("HAS_TV_RANDOMIZED_LIST");
    }
