...
> **_NOTE:_**  Quarkus now ships with a Dev UI, which is available in dev mode only at http://host.docker.internal:8080/q/dev/.
...
You can then execute your native executable with: `./target/content-service-1.0-SNAPSHOT-runner`
